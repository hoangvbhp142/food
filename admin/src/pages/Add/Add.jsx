...
const Add = ({url}) => {
  ...
  return (
    <div className='add'>
      <form className='flex-col' action="" onSubmit={onSubmitHandle}>
        ...
        <div className="add-product-name flex-col">
            <p>Product Name</p>
            <input onChange={onChangeHandle} value={data.name} type="text" placeholder='Type here' name='name'/>
        </div>
        ...
        <div className="add-category-price">
            <div className="add-category flex-col">
                ...
                <select onChange={onChangeHandle} name="category" id="category">
